-- ============================================================
-- 022_pending_quality.sql
-- Aggiunge la colonna quality (bellezza 1-5) a pending_ascents e la
-- propaga in import_pending_for_route() quando l'ascensione viene
-- importata dalla coda.
-- ============================================================
